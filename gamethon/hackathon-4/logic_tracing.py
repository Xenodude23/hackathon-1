...
def find_majority_element(nums):
    ...
    if not nums:
        ...
        return None  # BUG: crashes instead of returning None added none
    ...
    # Should verify count > n/2 before returning
...
def calculate_compound_interest(principal, rate, compounds_per_year, years):
    ...
    amount = principal * (1 + rate / compounds_per_year) ** (compounds_per_year * years) # added brackets
